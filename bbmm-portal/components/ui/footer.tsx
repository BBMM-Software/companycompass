      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        ...
        <div className="sm:grid-cols-12 gap-8 py-8 md:py-12 border-t border-gray-200 flex justify-between content-center">
          ...
          <div className="sm:col-span-6 md:col-span-3 lg:col-span-3">
            ...
            <p className="text-sm text-gray-600 mb-4">Get monthly news about our products</p>
            <form>
        ...
        <div className="md:flex md:items-center md:justify-between py-4 md:py-8 border-t border-gray-200">
          ...
          <div className="text-sm text-gray-600 mr-4">&copy; OURDOMAIN.COM All rights reserved.</div>
