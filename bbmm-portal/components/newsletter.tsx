          ...
          <div className="relative bg-gray-900 rounded py-10 px-8 md:py-16 md:px-12 shadow-2xl overflow-hidden" data-aos="zoom-y-out">
              ...
              <svg width="428" height="328" xmlns="http://www.w3.org/2000/svg">
                <defs>
                  <radialGradient cx="35.542%" cy="34.553%" fx="35.542%" fy="34.553%" r="96.031%" id="ni-a">
                    ...
                    <stop stopColor="#a2dee8" offset="44.317%" />
                    <stop stopColor="#5f1aeb" offset="100%" />
                  </radialGradient>
                </defs>
            ...
            <div className="relative flex flex-col lg:flex-row justify-between items-center">
              ...
              <div className="text-center lg:text-left lg:max-w-xl">
                <h3 className="h3 text-white mb-2">Want to shcedule a call with us?</h3>
                ...
                <form className="w-full lg">
                  <div className="flex flex-col sm:flex-row justify-center max-w-xl mx-auto sm:max-w-md lg:mx-0">
                    ...
                    <a className="btn text-white bg-blue-600 hover:bg-blue-700 shadow" href="#0">Check availability</a>
                  </div>
                  {/* Success message */}
